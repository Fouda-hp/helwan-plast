...
class AdminPanel(AdminPanelTemplate):
    ...
    def get_pending_users(self):
        return anvil.server.call('get_pending_users', self.get_token())

    def get_all_users(self):
        return anvil.server.call('get_all_users', self.get_token())

    def approve_user(self, user_id, role):
        return anvil.server.call('approve_user', self.get_token(), user_id, role)

    def reject_user(self, user_id):
        return anvil.server.call('reject_user', self.get_token(), user_id)

    def update_user_role(self, user_id, new_role):
        return anvil.server.call('update_user_role', self.get_token(), user_id, new_role)

    def toggle_user_active(self, user_id):
        return anvil.server.call('toggle_user_active', self.get_token(), user_id)

    def reset_user_password(self, user_id, new_password):
        return anvil.server.call('reset_user_password', self.get_token(), user_id, new_password)

    # Audit Logs
    def get_audit_logs(self, limit, offset, filters):
        return anvil.server.call('get_audit_logs', self.get_token(), limit, offset, filters)
