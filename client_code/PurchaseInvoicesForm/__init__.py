...
class PurchaseInvoicesForm(PurchaseInvoicesFormTemplate):
    ...
    def get_purchase_invoices(self, status='', search=''):
        return self._safe_call('get_purchase_invoices', status, search, self._auth())

    def create_purchase_invoice(self, data):
        return self._safe_call('create_purchase_invoice', data, self._auth())

    def update_purchase_invoice(self, invoice_id, data):
        return self._safe_call('update_purchase_invoice', invoice_id, data, self._auth())

    def delete_purchase_invoice(self, invoice_id):
        return self._safe_call('delete_purchase_invoice', invoice_id, self._auth())

    def post_purchase_invoice(self, invoice_id):
        """Post a draft invoice → DR 1210, CR 2000 (Transit model)."""
        return self._safe_call('post_purchase_invoice', invoice_id, self._auth())

    def move_purchase_to_inventory(self, invoice_id):
        """Move posted invoice from 1210 (Transit) to 1200 (Inventory). Idempotent."""
        return self._safe_call('move_purchase_to_inventory', invoice_id, self._auth())
    ...
    def record_invoice_payment(self, invoice_id, amount, method='cash', notes=''):
        ...
        return self._safe_call('record_invoice_payment', invoice_id, amount, method, notes, self._auth())
    ...
    def get_supplier_remaining_egp(self, invoice_id):
        ...
        return self._safe_call('get_supplier_remaining_egp', invoice_id, self._auth())
    ...
    def add_import_cost(self, invoice_id, cost_type, amount, description='',
        ...
        return self._safe_call('add_import_cost', invoice_id, cost_type, amount,
    ...
    def get_import_costs(self, invoice_id, inventory_id=None):
        ...
        return self._safe_call('get_import_costs', invoice_id, inventory_id, self._auth())
    ...
    def get_import_costs_for_payment(self, purchase_invoice_id):
        ...
        return self._safe_call('get_import_costs_for_payment', purchase_invoice_id, self._auth())
    ...
    def pay_import_cost(self, import_cost_id, amount_egp, payment_method, payment_date):
        ...
        return self._safe_call('pay_import_cost', import_cost_id, amount_egp, payment_method, payment_date, self._auth())

    def get_import_cost_types(self):
        """Get extensible import cost types (from table or built-in)."""
        return self._safe_call('get_import_cost_types', self._auth())

    def get_landed_cost(self, purchase_invoice_id):
        """Calculate landed cost = FOB + Cylinders + all import costs."""
        return self._safe_call('get_landed_cost', purchase_invoice_id, None, self._auth())
    ...
    def create_contract_purchase(self, contract_number, fob_cost, cylinder_cost,
        ...
        """
        return self._safe_call('create_contract_purchase', contract_number,
    ...
    def get_contracts_list(self):
        ...
        return self._safe_call('get_contracts_list_simple', self._auth())

    # --- Suppliers & Details ---
    def get_suppliers_list(self):
        return self._safe_call('get_suppliers_list_simple', self._auth())

    def get_service_suppliers_list(self):
        """Get service suppliers for dropdown (import cost assignment)."""
        return self._safe_call('get_service_suppliers_list_simple', self._auth())

    def get_invoice_details(self, invoice_id):
        return self._safe_call('get_invoice_details', invoice_id, self._auth())
